...
class solicitud_activo
{
	...
	function solicitud_activo()
	{
		$this->bd = new Conexion();
	}
	function registrar_solicitud_activo($nro_solicitud_activo, $fecha_solicitud, $oficina_solicitante, $item_solicitante,$nombre_solicitante, $justificativo, $autorizado_por, $gerente_area, $existencia_activo, $estado_solicitud_activo, $id_usuario)
	{
	...
	function registrar_solicitud_activo_no($nro_solicitud_activo, $fecha_solicitud, $unidad_solicitante, $item_solicitante,$nombre_solicitante, $justificativo, $objetivo_contratacion, $existencia_activo, $estado_solicitud_activo, $id_usuario)
	{
		$registros = $this->bd->Consulta("INSERT INTO solicitud_activo (nro_solicitud_activo,
										fecha_solicitud, 
										unidad_solicitante, 
										item_solicitante, 
										nombre_solicitante,justificativo, 
