...
class solicitud_material
{
	...
	function solicitud_material()
	{
		$this->bd = new Conexion();
	}
	function registrar_solicitud_material($nro_solicitud_material, $fecha_solicitud, $oficina_solicitante, $item_solicitante,$nombre_solicitante, $justificativo, $autorizado_por, $gerente_area, $existencia_material, $estado_solicitud_material, $id_usuario)
	{
	...
	function registrar_solicitud_material_no($nro_solicitud_material, $fecha_solicitud,$unidad_solicitante, $item_solicitante,$nombre_solicitante, $justificacion, $objetivo_contratacion, $existencia_material, $estado_solicitud_material, $id_usuario){
		$registros = $this->bd->Consulta("INSERT INTO solicitud_material (
			nro_solicitud_material,
			fecha_solicitud,
			unidad_solicitante, 
