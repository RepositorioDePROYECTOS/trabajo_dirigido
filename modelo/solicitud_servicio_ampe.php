...
class solicitud_servicio_ampe
{
	public $id_solicitud_servicio;
    public $nro_solicitud_servicio;
    public $fecha_solicitud;
	public $oficina_solicitante;
	public $programa_solicitud_servicio;
	public $actividad_solicitud_servicio;
	...
	function solicitud_servicio_ampe()
	{
		$this->bd = new Conexion();
	}
	function registrar_solicitud_servicio($nro_solicitud_servicio,
		$fecha_solicitud, 
		$programa_solicitud_servicio,
		$actividad_solicitud_servicio,
		$oficina_solicitante, 
		$item_solicitante, 
		$nombre_solicitante, 
		$justificativo, 
	...
	function modificar_solicitud_servicio($id_solicitud_servicio,$justificativo, $gerente_area, $autorizado_por)
	{
	   $registros = $this->bd->Consulta("update solicitud_servicio set justificativo='$justificativo', gerente_area='$gerente_area', autorizado_por='$autorizado_por' where id_solicitud_servicio=$id_solicitud_servicio");
		if($this->bd->numFila_afectada($registros)>0)
			return true;
		else
			return false;
