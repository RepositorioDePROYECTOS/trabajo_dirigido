...
create table if not exists formacion(
  id_formacion int(11) not null auto_increment primary key,
...
create table if not exists solicitud_material(
	id_solicitud_material int(11) not null auto_increment primary key,
...
create table if not exists detalle_material(
	id_detalle_material int(11) not null auto_increment primary key,
	descripcion varchar(200) not null,
	unidad_medida varchar(50) not null,
	cantidad_solicitada int(5) not null,
	cantidad_despachada int(5) not null,
...
create table if not exists material_despachado(
	id_material_despachado int(11) not null auto_increment primary key,
	fecha_despacho datetime not null,
	descripcion varchar(200) not null,
	unidad_medida varchar(50) not null,
	cantidad_desapachada int(5) not null,
	id_solicitud_material int(11) not null,
	foreign key(id_solicitud_material) references solicitud_material(id_solicitud_material)
)ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
create table if not exists solicitud_servicio(
	id_solicitud_servicio int(11) not null auto_increment primary key,
	...
	autorizado_por varchar(200) not null,
	visto_bueno varchar(200) not null,
	fecha_registro_adquisiciones date not null, 
...
create table if not exists detalle_servicio(
	id_detalle_solicitud int(11) not null auto_increment primary key,
	descripcion varchar(200) not null,
	cantidad_solicitada float(9,2) NOT NULL,
	precio_unitario float(9,2) NOT NULL,
	id_solicitud_servicio int(11) not null,
	foreign key(id_solicitud_servicio) references solicitud_servicio(id_solicitud_servicio)
)ENGINE=InnoDB DEFAULT CHARSET=utf8;
