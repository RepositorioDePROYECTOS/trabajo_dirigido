...
$programa_solicitud_servicio   = utf8_decode($_POST[programa_solicitud_servicio]);
$actividad_solicitud_servicio  = utf8_decode($_POST[actividad_solicitud_servicio]);
...
$result = $solicitud_servicio->registrar_solicitud_servicio(
		$nro_solicitud_servicio,
		$fecha_solicitud, 
...
{
	echo "Ocuri&oacute; un Error. nro: ". "INSERT INTO solicitud_servicio (nro_solicitud_servicio,
	fecha_solicitud, 
	programa_solicitud_servicio, 
	actividad_solicitud_servicio, 
	oficina_solicitante, 
