...
$file_input        = (!empty($_FILES['hoja_vida']['name'])) ? $_FILES['hoja_vida'] : '';
$fecha_solicitud   = date("Y-m-d H:i:s");
$target_dir = "../../files/hoja_vida" . DIRECTORY_SEPARATOR;
$target_file = $target_dir . $id_trabajador . "_" . "HOJA DE VIDA" . "_" . $fecha_solicitud . ".pdf";
$uploadOk = 1;
...
if ($uploadOk == 0) {
    ...
    if (move_uploaded_file($file_input["tmp_name"], $target_file)) {
        $consulta = $bd->Consulta("INSERT INTO `files`(`id_trabajador`, `tipo`, `fecha_creacion`) VALUES ($id_trabajador, 'HOJA DE VIDA', '$fecha_solicitud')");
