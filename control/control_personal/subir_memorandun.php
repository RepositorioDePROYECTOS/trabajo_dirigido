...
$file_input        = (!empty($_FILES['memorandun']['name'])) ? $_FILES['memorandun'] : '';
$fecha_solicitud   = date("Y-m-d H:i:s");
$target_dir = "../../files/memorandun" . DIRECTORY_SEPARATOR;
$target_file = $target_dir . $id_trabajador . "_" . "MEMORANDUN" . "_" . $fecha_solicitud . ".pdf";
$uploadOk = 1;
...
if ($uploadOk == 0) {
    ...
    if (move_uploaded_file($file_input["tmp_name"], $target_file)) {
        $consulta = $bd->Consulta("INSERT INTO `files`(`id_trabajador`, `tipo`, `fecha_creacion`) VALUES ($id_trabajador, 'MEMORANDUN', '$fecha_solicitud')");
