...
$id_conf_bono_antiguedad = $_POST[id_conf_bono_antiguedad];
...
$result = $conf_bono_antiguedad->modificar_conf_bono_antiguedad($id_conf_bono_antiguedad, $anio_i, $anio_f,  $porcentaje, $estado_bono);
if($result)
{
