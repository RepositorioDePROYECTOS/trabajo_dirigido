...
$id_suplencia = utf8_decode($_POST[id_suplencia]);
...
$result = $suplencia->modificar_suplencia($id_suplencia, $mes, $gestion, $fecha_inicio, $fecha_fin, $total_dias, $suplir[descripcion], $suplir[salario_mensual], $monto, $id_asignacion_cargo);
if($result)
{
