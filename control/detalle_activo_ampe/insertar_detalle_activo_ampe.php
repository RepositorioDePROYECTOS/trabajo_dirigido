<?php
    ...
    // if($precio_total > 50000) {
      if($verificar_m[descripcion] != $descripcion && $verificar_m[unidad_medida] != $unidad_medida){
        $registros = $bd->Consulta("INSERT INTO detalle_activo (id_detalle_activo, descripcion, unidad_medida, cantidad_solicitada, cantidad_despachada, precio_unitario, precio_total, id_solicitud_activo)
        VALUES('',
              '$descripcion',
              '$unidad_medida',
              '$cantidad_solicitada',
      ...
      // $message = "INSERT INTO detalle_activo 
      // VALUES('',
      // 	  '$descripcion',
      // 	  '$unidad_medida',
      // 	  '$cantidad_solicitada',
