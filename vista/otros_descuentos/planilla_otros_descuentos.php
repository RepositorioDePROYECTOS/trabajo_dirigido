...
?>
<h2>Cargar Planilla Otros Descuentos</h2>
<br />
<div class="panel panel-default panel-shadow" data-collapsed="0">
	...
	<div class="panel-body">
		<form name="frm_otros_descuentos" id="frm_otros_descuentos" action="control/otros_descuentos/generar_planilla_otros_descuentos.php" method="post" role="form" class="validate form-horizontal form-groups-bordered">
