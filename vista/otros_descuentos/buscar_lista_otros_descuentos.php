<?php
    $anio = date("Y");
?>
<h2>Planilla otros descuentos</h2>
  <br />
  <div class="panel panel-default panel-shadow" data-collapsed="0">
    ...
    <div class="panel-body">
        ...
        <form name="frm_buscar_otros_descuentos" id="frm_buscar_otros_descuentos" action="?mod=otros_descuentos&pag=lista" method="GET" role="form" class="form-horizontal form-groups-bordered">
            <input type="hidden" name="mod" value="otros_descuentos"/>
