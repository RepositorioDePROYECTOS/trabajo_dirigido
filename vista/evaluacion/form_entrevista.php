...
<div class="panel panel-default panel-shadow" data-collapsed="0">
    <div class="panel-heading">
        <div class="panel-title">
            Nueva Pregunta de Entrevista
        </div>
    </div>
    <div class="panel-body">
        <form name="frm_pregunta" id="frm_pregunta" action="control/entrevistas/agregar_pregunta.php" method="post" role="form" class="validate form-horizontal form-groups-bordered">
