<?php
	$anio = date("Y");
?>
<h2>Lista de descargo para refrigerio</h2>
  <br />
  <div class="panel panel-default panel-shadow" data-collapsed="0">
	...
	<div class="panel-body">
		...
		<form name="frm_descargo_refrigerio" id="frm_descargo_refrigerio" action="?mod=descargo_refrigerio&lista" method="GET" role="form" class="form-horizontal form-groups-bordered">
			<input type="hidden" name="mod" value="descargo_refrigerio"/>
