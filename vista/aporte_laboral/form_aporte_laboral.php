<?php
    ...
    $registros = $bd->Consulta("select * from asignacion_cargo ac inner join trabajador t on ac.id_trabajador=t.id_trabajador where estado_asignacion='HABILITADO' and id_asignacion_cargo not in(select id_asignacion_cargo from aporte_laboral where mes=$mes and gestion=$gestion)");
?>
<h2>Cargar aporte laboral</h2>
<br />
<div class="panel panel-default panel-shadow" data-collapsed="0">
	...
	<div class="panel-body">
		<form name="frm_aporte_laboral" id="frm_aporte_laboral" action="control/aporte_laboral/insertar_aporte_laboral.php" method="post" role="form" class="validate form-horizontal form-groups-bordered">
