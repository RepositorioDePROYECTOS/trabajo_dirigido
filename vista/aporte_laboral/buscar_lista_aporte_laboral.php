...
<h2>Aporte laboral</h2>
  ...
  <div class="panel panel-default panel-shadow" data-collapsed="0">
    ...
    <div class="panel-body">
        ...
        <form name="frm_buscar_aporte" id="frm_buscar_aporte" action="?mod=aporte_laboral&pag=lista" method="GET" role="form" class="form-horizontal form-groups-bordered">
            <input type="hidden" name="mod" value="aporte_laboral"/>
