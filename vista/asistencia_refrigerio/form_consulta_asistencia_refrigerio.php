<?php
	$anio = date("Y");
?>
<h2>Lista de Asistencia para refrigerio</h2>
  <br />
  <div class="panel panel-default panel-shadow" data-collapsed="0">
	...
	<div class="panel-body">
		...
		<form name="frm_asistencia_refrigerio" id="frm_asistencia_refrigerio" action="?mod=asistencia_refrigerio&lista" method="GET" role="form" class="form-horizontal form-groups-bordered">
			<input type="hidden" name="mod" value="asistencia_refrigerio"/>
