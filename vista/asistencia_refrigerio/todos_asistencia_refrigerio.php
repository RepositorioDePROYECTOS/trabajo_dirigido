<?php
	...
	$mes = $_REQUEST['mes'];
?>
<h2>Generar planilla de asistencia</h2>
<br />
<div class="panel panel-default panel-shadow" data-collapsed="0">
	...
	<div class="panel-body">
		<form name="frm_todos_asistencia_refrigerio" id="frm_todos_asistencia_refrigerio" action="control/asistencia_refrigerio/insertar_todos_asistencia_refrigerio.php" method="post" role="form" class="validate form-horizontal form-groups-bordered">
