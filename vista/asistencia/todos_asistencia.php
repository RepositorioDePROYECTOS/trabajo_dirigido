...
<div class="panel panel-default panel-shadow" data-collapsed="0">
	...
	<div class="panel-body">
		<form name="frm_todos_asistencia" id="frm_todos_asistencia" action="control/asistencia/insertar_todos_asistencia.php" method="post" role="form" class="validate form-horizontal form-groups-bordered">
