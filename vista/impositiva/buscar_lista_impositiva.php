...
<h2>Planilla impositiva</h2>
  ...
  <div class="panel panel-default panel-shadow" data-collapsed="0">
    ...
    <div class="panel-body">
        ...
        <form name="frm_buscar_impositiva" id="frm_buscar_impositiva" action="?mod=impositiva&pag=lista" method="GET" role="form" class="form-horizontal form-groups-bordered">
            <input type="hidden" name="mod" value="impositiva"/>
