<?php
    ...
    $registros = $bd->Consulta("select * from asignacion_cargo ac inner join trabajador t on ac.id_trabajador=t.id_trabajador where estado_asignacion='HABILITADO' and id_asignacion_cargo not in(select id_asignacion_cargo from impositiva where mes=$mes and gestion=$gestion)");
?>
<h2>Cargar impositiva</h2>
<br />
<div class="panel panel-default panel-shadow" data-collapsed="0">
	...
	<div class="panel-body">
		<form name="frm_impositiva" id="frm_impositiva" action="control/impositiva/insertar_impositiva.php" method="post" role="form" class="validate form-horizontal form-groups-bordered">
