...
<h2>Horas extra</h2>
  ...
  <div class="panel panel-default panel-shadow" data-collapsed="0">
	...
	<div class="panel-body">
		...
		<form name="frm_horas_extra" id="frm_horas_extra" action="?mod=horas_extra&lista.php" method="GET" role="form" class="form-horizontal form-groups-bordered">
			<input type="hidden" name="mod" value="horas_extra"/>
