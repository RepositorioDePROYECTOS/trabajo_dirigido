...
jQuery(document).ready(function($) {
    ...
    function editar() {
        ...
        if (isNaN(cantidad_despachada) || cantidad_despachada < 0) {
            ...
            $.ajax({
                type: "POST",
                url: "control/detalle_material_ampe/editar_detalle_material_ampe.php",
                data: {
                ...
                if (data.success === true) {
                    ...
                    var param = "?mod=solicitud_material&pag=detalle_material_ampe&id_solicitud_material="+id_solicitud_material;
                    console.log(param);
