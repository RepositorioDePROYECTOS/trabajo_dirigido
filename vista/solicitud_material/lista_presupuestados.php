...
?>
<h2>
    Lista de Solicitudes de Materiales Presupuestados
...
<thead>
    ...
    <tbody>
        ...
        <?php echo utf8_encode("<td>$registro[fecha_solicitud]</td>");
            ...
            echo "<td>
                <a href='?mod=solicitud_material&pag=editar_solicitud_material_detalles&id=$registro[id_solicitud_material]'
                    class='btn btn-orange btn-lg btn-xs' 
                    style='float: right; margin-right: 50px;'
                >
                    Editar <i class='entypo-pencil'></i>
                </a>
                <span class='btn btn-info btn-xs'>$registro[estado_solicitud_material]</span>
                </td>";
        };
        ?>
    </tbody>
