...
<div class="panel panel-default panel-shadow" data-collapsed="0">
    ...
    <div class="panel-body">
        <form name="frm_solicitud_material" id="frm_solicitud_material"
            action="control/solicitud_material_ampe/editar_solicitud_material_ampe.php" method="post" role="form"
            class="validate form-horizontal form-groups-bordered">
            <input type="hidden" name="id_solicitud_material" id="id_solicitud_material"
                class="form-control required text" value='<?php echo $id_solicitud_material;?>' />
            <div class="form-group">
                ...
                <label for="programa_solicitud_material" class="col-sm-1 control-label">Programa</label>
                <div class="col-sm-2">
                    <input type="text" name="programa_solicitud_material" id="programa_solicitud_material"
                        class="form-control required" value="<?php echo $registro_sol[programa_solicitud_material];?>"
                        disabled />
                </div>
                <label for="actividad_solicitud_material" class="col-sm-1 control-label">Actividad</label>
                <div class="col-sm-2">
                    <input type="text" name="actividad_solicitud_material" id="actividad_solicitud_material"
                        class="form-control required" value="<?php echo $registro_sol[actividad_solicitud_material];?>"
                        disabled />
                </div>
                <label for="existencia_material" class="col-sm-1 control-label">Material con existencia</label>
                <div class="col-sm-2">
                    <input type="text" name="existencia_material" id="existencia_material" class="form-control required"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <textarea name="justificativo" id="justificativo" class="form-control required text uppercase"
                        rows="4"><?php echo utf8_encode($registro_sol[justificativo]);?></textarea>
                </div>
