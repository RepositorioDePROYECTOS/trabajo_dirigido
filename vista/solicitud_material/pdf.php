...
$numero_de_orden = $registro[nro_solicitud_material];

$registros_s = $bd->Consulta("SELECT d.*,p.nombre_partida from detalle_material as d LEFT JOIN partidas as p ON p.id_partida = d.id_partida WHERE d.id_solicitud_material=$id_solicitud_material");
...
<?php if ($registro[existencia_material] == 'NO') { ?>
    <div class="cabecera">
        <h1 align="center" style="color:white;">
            ...
            <br>
            MATERIALES   Nro. <?php echo str_pad($numero_de_orden, 6, "0", STR_PAD_LEFT); ?>
        </h1>
    </div>
...
<?php } else { ?>
    <h1 align="center">SOLICITUD DE MATERIALES
        ...
        ?>
        <br>Nro.
        <?php echo str_pad($registro[nro_solicitud_material], 6, "0", STR_PAD_LEFT); ?>
    </h1>

<?php } ?>
<table align="center" width="685" class="tabla_reporte">
    <tr class="cabecera-tabla">
        <td colspan="4" align="center"><strong>PAPELETA SOLICITUD</strong></td>
    </tr>
    <tr>
        <td width="130"><strong>ITEM:</strong></td>
        <td width="305"><?php echo $registro[item_solicitante]; ?></td>
        <td width="160"><strong>FECHA SOLICITUD:</strong></td>
        <td width="90"><?php echo date("d-m-Y", strtotime($registro[fecha_solicitud])); ?></td>
    </tr>
    <tr>
        <td width="130"><strong>UNIDAD SOLICITANTE:</strong></td>
        <td width="305" colspan="3"><?php echo ($registro[unidad_solicitante] != NULL) ? strtoupper(utf8_encode($registro[unidad_solicitante])) : strtoupper(utf8_encode($registro[oficina_solicitante])); ?></td>
    </tr>
    <?php if ($registro[existencia_material] == "SI") { ?>
        <tr>
    ...
    <tr>
        ...
        <td width="555" colspan="3"><?php echo strtoupper(utf8_encode($registro[justificativo])); ?></td>
    </tr>
</table>
<?php if ($registro[existencia_material] == "NO") { ?>
    <table align="center" width="600" class="tabla_reporte">
        ...
        <tr class="cabecera-tabla">
            ...
            <td width="60" align="center"><strong class="letra_9">Unidad Medida</strong></td>
            <td width="405" align="center"><strong class="letra_9">Descripción</strong></td>
            <!-- <td width="150" align="center"><strong class="letra_9">Partida Presupuestaria</strong></td> -->
            <td width="60" align="center"><strong class="letra_9">Precio Unitario <br> Referencia (Bs.)</strong></td>
            <td width="60" align="center"><strong class="letra_9">Precio Total <br>Referencia (Bs.)</strong></td>
        </tr>
        <?php
        $total = 0;
        while ($registro_s = $bd->getFila($registros_s)) {
            ...
            echo strtoupper(utf8_encode(
                "
                    ...
                    <td width='60' class='letra_9 salto-texto' align='center'>$registro_s[cantidad_solicitada]</td>
                    <td width='60' class='letra_9 salto-texto'>$registro_s[unidad_medida]</td>
                    <td width='405' class='letra_9 salto-texto'>$registro_s[descripcion]</td>
                    
                    <td width='60' class='letra_9 salto-texto' align='right'>$registro_s[precio_unitario]</td>
                    <td width='60' class='letra_9 salto-texto' align='right'>".number_format($subtotal, 2, ',', '.')."</td>"
            ));
            // <td width='150' class='letra_9 salto-texto' width='190' align='center'>$registro_s[nombre_partida]</td>
            echo "</tr>";
...
?>
    ...
    <page backtop="25mm" backbottom="14mm" backleft="0mm" backright="0mm" backimg="" style="font-size: 10pt">
        ...
        <?php
        // include("../reportes/inicio_pagina_logo.php");
        $especificaciones_tecnicas = $bd->Consulta("SELECT s.unidad_solicitante, s.objetivo_contratacion, s.nombre_solicitante, dm.descripcion, dm.id_detalle_material 
        FROM solicitud_material as s 
        INNER JOIN detalle_material as dm ON dm.id_solicitud_material = s.id_solicitud_material 
        WHERE s.id_solicitud_material=$id_solicitud_material");
        // echo "<br><br><br><br><br><br><br><br><br><br>DATOS: ";
        // echo "SELECT s.unidad_solicitante, s.objetivo_contratacion, s.nombre_solicitante, dm.descripcion, dm.id_detalle_material 
        // FROM solicitud_material as s 
        // INNER JOIN detalle_material as dm ON dm.id_solicitud_material = s.id_solicitud_material 
        // WHERE s.id_solicitud_material=$id_solicitud_material";
        ...
        ?>
        <!-- <div class="cabecera">
                <h1 align="center" style="color:white;">FORMULARIO CM - 01 <br> ESPECIFICACIONES TECNICAS</h1>
            </div> -->
        <table align="center" width="600" class="cabecera2">
            ...
            <tr>
                ...
                <td width="450"><?php echo strtoupper(utf8_encode($especificacion[unidad_solicitante])); ?></td>
            </tr>
            <tr>
                <td width="150" class="cabecera-tabla"><strong>OBJETIVO DE CONTRATACION:</strong></td>
                <td width="450"><?php echo strtoupper(utf8_encode($especificacion[objetivo_contratacion])) ?></td>
            </tr>
            <tr>
        ...
        <br>
        <?php
        $iteracion_especificaciones_tecnicas = $bd->Consulta("SELECT dm.descripcion, dm.id_detalle_material 
        FROM solicitud_material as s 
        INNER JOIN detalle_material as dm ON dm.id_solicitud_material = s.id_solicitud_material 
        WHERE s.id_solicitud_material=$id_solicitud_material");
        ...
        ?>
            <table align="center" width="600" class="tabla_reporte">
                <tr>
                    ...
                    <td width="450" class="cabecera-tabla"><?php echo utf8_encode($datos_iteracion[descripcion]); ?></td>
                </tr>
            ...
            <table align='center' width="600" class='tabla_reporte'>
                ...
                <?php $especificaciones = $bd->Consulta("SELECT * FROM especificaciones_material WHERE id_detalle_material=$datos_iteracion[id_detalle_material]");
                $index = 1;
            ...
            <?php
            $buscar_datos = $bd->Consulta("SELECT dm.descripcion, dm.id_detalle_material 
                FROM solicitud_material as s 
                INNER JOIN detalle_material as dm ON dm.id_solicitud_material = s.id_solicitud_material 
                INNER JOIN especificaciones_material as em ON em.id_detalle_material = dm.id_detalle_material
                WHERE em.id_detalle_material = $datos_iteracion[id_detalle_material]");
        ...
        <!-- <div class="break"></div> -->
    <?php } else { ?>
        <table width="600" align="center" class="tabla_reporte">
            <tr>
                <td width="180" height="100" align="center"><br><br><br><br><br><br><?php echo utf8_encode($registro[nombre_solicitante]); ?><br><strong>FIRMA SOLICITANTE</strong></td>
