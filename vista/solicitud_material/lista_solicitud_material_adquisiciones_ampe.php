<?php
    ...
    $registros = $bd->Consulta("SELECT * 
        ...
        AND s.estado_solicitud_material IN ('ADQUISICION','COMPRADO', 'DESPACHADO_SIN_EXISTENCIA')
    ...
    while($registro = $bd->getFila($registros)) 
    {
        ...
        echo utf8_encode("
            ...
            if($registro[estado_solicitud_material]=='ADQUISICION' || $registro[estado_solicitud_material]=='COMPRADO'){
                ...
                <a target='_blank' href='vista/reportes/visor_reporte.php?f=vista/solicitud_material/pdf_ampe.php&id=$registro[id_solicitud_material]' class='btn btn-info btn-icon' style='float: right; margin-right: 5px;'>Imprimir<i class='entypo-print'></i></a><br>";
            }
           echo "</td>";
