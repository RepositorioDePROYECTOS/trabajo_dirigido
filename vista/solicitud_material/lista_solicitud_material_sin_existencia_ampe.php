<?php
    ...
    AND s.estado_solicitud_material='SIN EXISTENCIA' 
    ORDER BY s.fecha_solicitud desc");  
?>
<h2>Lista de Solicitudes de Material Sin existencia</h2>
...
<?php if($_SESSION[nivel] == 'ALMACENERO'){ ?>
<a href="?mod=solicitud_material&pag=lista_solicitud_material_aprobado_ampe" class="btn btn-info btn-icon" style="float: right;">
...
<table class="table table-bordered datatable" id="table-1">
    ...
    while($registro = $bd->getFila($registros)) 
    {
        ...
        echo utf8_encode("
            ...
            echo "<td>";
            if($registro[estado_solicitud_material]=='DESPACHADO' ||$registro[estado_solicitud_material]=='SIN EXISTENCIA'){
                ...
                <a target='_blank' href='vista/reportes/visor_reporte.php?f=vista/solicitud_material/material_despachado_pdf_ampe.php&id=$registro[id_solicitud_material]' class='btn btn-info btn-icon' style='float: right; margin-right: 5px;'>Imprimir<i class='entypo-print'></i></a><br>";
            }
        echo "</td>";
    };	
?>
