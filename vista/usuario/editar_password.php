...
<div class="panel panel-default panel-shadow" data-collapsed="0">
	...
	<div class="panel-body">
		<form name="frm_usuario" id="frm_usuario" action="control/usuario/cambio_password.php" method="post" role="form" class="validate_edit form-horizontal form-groups-bordered">
            ...
            <div class="form-group">
				...
				<div class="col-sm-5">
					<input type="text" name="correo" id="correo" class="form-control required text" value="<?php echo $usuario->correo; ?>" readonly="true"/></td>
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input type="text" name="nombre_ap" id="nombre_ap" class="form-control required text" value="<?php echo utf8_encode($usuario->nombre_ap); ?>" readonly="true"/></td>
				</div>
			</div>
			<div class="form-group">
