<?php
    ...
    $registros = $bd->Consulta("select * from ingreso_funcionario i inner join usuario u on u.id_usuario=i.id_usuario inner join trabajador t on t.id_trabajador=u.id_trabajador where i.estado_ingreso='RECHAZADO' order by i.fecha_ingreso asc");  
?>
