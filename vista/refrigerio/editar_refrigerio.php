	...
	<div class="panel-body">
		<form name="frm_refrigerio" id="frm_refrigerio" action="control/refrigerio/editar_refrigerio.php" method="post" role="form" class="validate_edit form-horizontal form-groups-bordered">
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input type="text" name="dias_asistencia" id="dias_asistencia" class="form-control required decimales"  placeholder='' value='<?php echo utf8_encode($refrigerio->dias_asistencia); ?>'/>
				</div>
			</div>
			<div class="form-group">
				<label for="otros" class="col-sm-3 control-label">Otros ingresos</label>
				<div class="col-sm-5">
					<input type="text" name="otros" id="otros" class="form-control required decimales"  placeholder='' value='<?php echo utf8_encode($refrigerio->otros); ?>'/>
				</div>
			</div>		
			<div class="form-group">
