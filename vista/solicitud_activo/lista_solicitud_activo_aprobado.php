...
?>
<h2>Lista de Solicitudes de activo Aprobados o Comprados</h2>
...
<?php if ($_SESSION[nivel] == 'ACTIVOS' || $_SESSION[nivel] == 'GERENTE ADMINISTRATIVO') { ?>
    ...
    <a href="?mod=solicitud_activo&pag=lista_solicitud_activo_sin_existencia" class="btn btn-orange btn-icon" style="float: right;margin-right: 5px;">
...
<table class="table table-bordered datatable" id="table-1">
    ...
    <tbody>
        ...
        <?php echo utf8_encode("<td>" . date('d-m-Y', strtotime($registro[fecha_solicitud])) . "</td>
            ...
            // if ($registro[estado_solicitud_activo] == 'APROBADO' || $registro[estado_solicitud_activo] == 'COMPRADO') {
