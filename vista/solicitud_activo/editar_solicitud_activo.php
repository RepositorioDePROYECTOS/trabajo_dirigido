...
<div class="panel panel-default panel-shadow" data-collapsed="0">
    ...
    <div class="panel-body">
        <form name="frm_solicitud_activo" id="frm_solicitud_activo" action="control/solicitud_activo/editar_solicitud_activo.php" method="post" role="form" class="validate form-horizontal form-groups-bordered">
            <input type="hidden" name="id_solicitud_activo" id="id_solicitud_activo" class="form-control required text" value='<?php echo $id_solicitud_activo; ?>' />
            <div class="form-group">
                <label for="fecha_solicitud" class="col-sm-2 control-label">Fecha solicitud</label>
                <div class="col-sm-3">
                ...
                <div class="col-sm-3">
                    <input type="text" name="existencia_activo" id="existencia_activo" class="form-control required" value="<?php echo $registro_sol[existencia_activo]; ?>" readonly />
                </div>
            </div>
            <div class="si-existe" style="display: none;">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <textarea name="justificativo" id="justificativo" class="form-control required text uppercase" rows="4"><?php echo $registro_sol[justificativo]; ?></textarea>
                    </div>
...
<script>
    window.addEventListener("load", function() {
        var valor = document.getElementById('existencia_activo').value;
        console.log(valor);
        if (valor == 'SI') {
