...
$registros = $bd->Consulta("SELECT * 
        ...
        -- inner join detalle_activo da on da.id_solicitud_activo = s.id_solicitud_activo
        -- inner join requisitos r on r.id_solicitud=s.id_solicitud_activo and r.id_derivaciones=d.id_derivacion -- WHERE s.objetivo_contratacion != 'ANPE'
        WHERE s.programa_solicitud_activo IS NULL
...
<table class="table table-bordered datatable" id="table-1">
    ...
    <tbody>
        ...
        while ($registro = $bd->getFila($registros)) {
            ...
            echo "<td><span class='btn btn-info btn-xs'>$registro[estado_solicitud_activo]</span></td>";
            ?>
            <td>
                <button type="button" class="btn btn-info btn-lg btn-xs" data-toggle="modal" data-target="#boton-modal_activo" data_id="<?php echo $registro[id_solicitud_activo] . '-activo' ?>" id="botones-modal" onclick="getReportes(<?php echo $registro[id_solicitud_activo]; ?>)">
                    Generar Reportes
                </button>
            </td>
            </tr>
...
<div class="modal fade" id="boton-modal_activo" role="dialog">
    <div class="modal-dialog modal-lg">
        <!-- Vista de la Solicitud content-->
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body" align="center">
                <a style="width: 450px;" target='_blank' class='letras_boton btn btn-info' id="print_form_1_activo" name="print_form_1_activo">
                    Imprimir
                    <i class='entypo-print'></i>
                </a>
                <br>
                <a style="width: 450px;" target='_blank' class="letras_boton btn btn-success" id="print_form_5_activo" name="print_form_5_activo">
                    Nota de Adjudicación
                    <i class="entypo-print"></i>
                </a>
                <br>
                <a style="width: 450px;" target='_blank' class="letras_boton btn btn-info" id="print_form_6_activo" name="print_form_6_activo">
                    Imprimir Orden de Material
                    <i class="entypo-print"></i>
                </a>
                <br>
                <a style="width: 450px;" target='_blank' class="letras_boton btn btn-success" id="print_form_2_activo" name="print_form_2_activo">
                    Acta conformidad
                    <i class="entypo-print"></i>
                </a>
                <br>
                <a style="width: 450px;" target='_blank' class="letras_boton btn btn-danger" id="print_form_3_activo" name="print_form_3_activo">
                    Acta no conformidad
                    <i class="entypo-print"></i>
                </a>
                <br>
                <a style="width: 450px;" target='_blank' class="letras_boton btn btn-warning" id="print_form_4_activo" name="print_form_4_activo">
                    Informe de Adjudicacion
                    <i class="entypo-print"></i>
                </a>
                <br>
                <a style="width: 450px;" target='_blank' class="letras_boton btn btn-success" id="print_form_7_activo" name="print_form_7_activo">
    ...
    function getReportes(id) {
        ...
        fetch('control/derivaciones/buscar_solicitud.php?id=' + id + '&tipo=' + tipo)
            ...
            .then(res => {
                ...
                let botones = ["print_form_1_activo", "print_form_5_activo", "print_form_6_activo", "print_form_2_activo", "print_form_3_activo", "print_form_4_activo", "print_form_7_activo"];
                let urls = [];
                console.log(respuesta);
                let timestamp = new Date().getTime(); // obtener el timestamp actual
                urls.push(`vista/solicitud_activo/pdf.php?id=${respuesta.id_solicitud_activo}&t=${timestamp}`);
                urls.push(`vista/derivaciones/nota_adjudicacion_pdf.php?id_solicitud=${respuesta.id_solicitud_activo}&id_detalle=${respuesta.id_detalle}&tipo=activo&t=${timestamp}`);
                urls.push(`vista/derivaciones/pdf.php?id_solicitud=${respuesta.id_solicitud_activo}&id_detalle=${respuesta.id_detalle}&tipo=activo&t=${timestamp}`);
                if (productos) {
                    urls.push(`vista/derivaciones/acta_conformidad_no_conformidad_pdf.php?id_solicitud=${respuesta.id_solicitud_activo}&id_detalle=${respuesta.id_detalle_activo}&tipo=activo&id_requisitos=${respuesta.id_requisitos}&conformidad=si&t=${timestamp}`);
                    urls.push(`vista/derivaciones/acta_conformidad_no_conformidad_pdf.php?id_solicitud=${respuesta.id_solicitud_activo}&id_detalle=${respuesta.id_detalle}&tipo=activo&id_requisitos=${respuesta.id_requisitos}&conformidad=no&t=${timestamp}`);
                    urls.push(`vista/derivaciones/pdf_proveedores_seleccionados.php?id_solicitud=${respuesta.id_solicitud_activo}&id_proveedor=${respuesta.id_proveedor}&tipo=activo&id_detalle=${respuesta.id_detalle}&t=${timestamp}`);
                    urls.push(`vista/derivaciones/acta_recepcion_pdf.php?id_solicitud=${respuesta.id_solicitud_activo}&id_detalle=${respuesta.id_detalle}&tipo=activo&id_requisitos=${respuesta.id_requisitos}&aclaracion=Sin Observaciones&t=${timestamp}`);
                }
                console.log(urls);
