...
?>
<h2>
    Lista de Solicitudes de activo Presupuestados
    <a href="?mod=solicitud_activo&pag=lista_solicitud_activo" class="btn btn-primary btn-icon" style="float: right;margin-right: 5px;">
        Solicitudes activo<i class="entypo-pencil"></i>
    </a>
</h2>
