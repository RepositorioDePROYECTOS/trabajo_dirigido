<?php
    ...
    AND s.estado_solicitud_activo IN ('APROBADO', 'COMPRADO') 
...
<a href="?mod=solicitud_activo&pag=lista_solicitud_activo_sin_existencia_ampe" class="btn btn-orange btn-icon" style="float: right;margin-right: 5px;">
