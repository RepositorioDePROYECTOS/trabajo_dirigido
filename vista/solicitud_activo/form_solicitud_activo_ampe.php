...
<div class="panel panel-default panel-shadow" data-collapsed="0">
	...
	<div class="panel-body">
		<form name="frm_solicitud_activo" id="frm_solicitud_activo" action="control/solicitud_activo_ampe/insertar_solicitud_activo_ampe.php" method="post" role="form" class="validate form-horizontal form-groups-bordered">
		...
		<input type="hidden" name="item_solicitante" id="item_solicitante" class="form-control required text" value='<?php echo $item_solicitante;?>'/>
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input type="text" name="fecha_solicitud" id="fecha_solicitud" readonly class="form-control required datepicker" value="<?php echo $fecha;?>"/>
					<input type="hidden" name="existencia_activo" id="existencia_activo" value="NO">
				</div>
			...
			<div class="form-group">
				<label for="programa_solicitud_activo" class="col-sm-3 control-label">Programa</label>
				<div class="col-sm-2">
					<select name="programa_solicitud_activo" id="programa_solicitud_activo" class="form-control required">
				...
				<div class="col-sm-2">
					<select name="actividad_solicitud_activo" id="actividad_solicitud_activo" class="form-control required">
							<option value="" selected>--SELECCIONE--</option>
