...
<h2>Bonos de antiguedad</h2>
  ...
  <div class="panel panel-default panel-shadow" data-collapsed="0">
	...
	<div class="panel-body">
		...
		<form name="frm_bono_antiguedad" id="frm_bono_antiguedad" action="?mod=bono_antiguedad&lista" method="GET" role="form" class="form-horizontal form-groups-bordered">
			<input type="hidden" name="mod" value="bono_antiguedad"/>
