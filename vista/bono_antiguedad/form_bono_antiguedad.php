...
<div class="panel panel-default panel-shadow" data-collapsed="0">
	...
	<div class="panel-body">
		<form name="frm_bono_antiguedad" id="frm_bono_antiguedad" action="control/bono_antiguedad/insertar_bono_antiguedad.php" method="post" role="form" class="validate form-horizontal form-groups-bordered">
