...
<h2>Planilla descuentos</h2>
  ...
  <div class="panel panel-default panel-shadow" data-collapsed="0">
    ...
    <div class="panel-body">
        ...
        <form name="frm_buscar_descuentos" id="frm_buscar_descuentos" action="?mod=descuentos&pag=lista" method="GET" role="form" class="form-horizontal form-groups-bordered">
            <input type="hidden" name="mod" value="descuentos"/>
