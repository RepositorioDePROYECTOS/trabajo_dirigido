...
<h2>Editar descuento</h2>
  ...
  <div class="panel panel-default panel-shadow" data-collapsed="0">
	...
	<div class="panel-body">
		<form name="frm_descuento" id="frm_descuento" action="control/descuentos/editar_descuentos.php" method="post" role="form" class="validate_edit form-horizontal form-groups-bordered">
