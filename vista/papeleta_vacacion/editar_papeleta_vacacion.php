	...
	<div class="panel-body">
		<form name="frm_detalle_vacacion" id="frm_detalle_vacacion" action="control/detalle_vacacion/editar_detalle_vacacion.php" method="post" role="form" class="validate_edit form-horizontal form-groups-bordered">
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input type="text" name="cantidad_dias" id="cantidad_dias" class="form-control required enteros"  placeholder='' value='<?php echo utf8_encode($detalle_vacacion->cantidad_dias); ?>'/>
				</div>
			</div>
			<div class="form-group">
				<label for="dias_utilizados" class="col-sm-3 control-label">D&iacute;as utilizados</label>
				<div class="col-sm-5">
					<input type="text" name="dias_utilizados" id="dias_utilizados" class="form-control required enteros"  placeholder='' value='<?php echo utf8_encode($detalle_vacacion->dias_utilizados);?>'/>
				</div>
			</div>
			<div class="form-group">
