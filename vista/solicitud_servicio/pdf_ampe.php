...
<h1 align="center">SOLICITUD DE SERVICIOS ANPE
<br>Nro.
    <?php echo str_pad($registro[nro_solicitud_servicio], 6, "0", STR_PAD_LEFT);?></h1>

    <table align="center" width="600" class="tabla_reporte">
        <tr class="titulo">
            <td colspan="4" align="center"><strong>PAPELETA SOLICITUD DE SERVICIOS</strong></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td width="90"><?php echo $registro[programa_solicitud_servicio];?></td>
        </tr>
        <tr>
            <td width="120"><strong>OFICINA SOLICITANTE:</strong></td>
            <td width="230"><?php echo utf8_encode($registro[oficina_solicitante]);?></td>
            <td width="160"><strong>ACTIVIDAD:</strong></td>
            <td width="90"><?php echo $registro[actividad_solicitud_servicio];?></td>
        </tr>
        <tr>
    ...
    <table align="center" width="100%" class="tabla_reporte">
        <tr class="titulo">
            <td colspan="6" align="center"><strong>DETALLE DE SERVICIOS</strong></td>
        </tr>
        <tr >
    ...
    <table align="center"  width="600" class="tabla_reporte">
        <tr>
            <td width="150" align="center"><br><br><br><br><?php echo utf8_encode($registro[nombre_solicitante]);?><br><strong>FIRMA SOLICITANTE</strong></td>
            <td width="150" align="center"><br><br><br><br><?php echo utf8_encode($registro[autorizado_por]);?><br><strong>AUTORIZADO
                    POR</strong></td>
            <td width="150" align="center"><br><br><br><br><?php echo utf8_encode($registro[gerente_area]);?><br><strong>GERENTE AREA</strong></td>        
            <td width="150" align="center"><br><br><br><br><?php echo utf8_encode($registro[visto_bueno]);?><br><strong>APROBADO
                    POR</strong></td>
        </tr>
    </table>
    <table align="center"  width="600" class="tabla_reporte">
        <tr>
            <td width="205" height="100" align="left"><br><br><br><br><br><br><br><strong>Fecha:__/__/____</strong><br><br><strong>VALIDADO POR</strong></td>
