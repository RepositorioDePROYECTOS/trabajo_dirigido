...
<div class="panel panel-default panel-shadow" data-collapsed="0">
    ...
    <div class="panel-body">
        <form name="frm_solicitud_servicio" id="frm_solicitud_servicio"
            action="control/solicitud_servicio_ampe/editar_solicitud_servicio_ampe.php" method="post" role="form"
            ...
            <div class="form-group">
                ...
                <label for="programa_solicitud_servicio" class="col-sm-1 control-label">Programa</label>
                <div class="col-sm-2">
                    <input type="text" name="programa_solicitud_servicio" id="programa_solicitud_servicio"
                        class="form-control required" value="<?php echo $registro_sol[programa_solicitud_servicio];?>"
                        disabled />
                </div>
                <label for="actividad_solicitud_servicio" class="col-sm-1 control-label">Actividad</label>
                <div class="col-sm-2">
                    <input type="text" name="actividad_solicitud_servicio" id="actividad_solicitud_servicio"
                        class="form-control required" value="<?php echo $registro_sol[actividad_solicitud_servicio];?>"
                        disabled />
                </div>
            </div>
            <div class="form-group">
