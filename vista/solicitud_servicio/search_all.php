...
$registros = $bd->Consulta("SELECT *
        ...
        -- inner join detalle_servicio ds on ds.id_solicitud_servicio = s.id_solicitud_servicio
        -- inner join requisitos r on r.id_solicitud=s.id_solicitud_servicio and r.id_derivaciones=d.id_derivacion
        WHERE s.programa_solicitud_servicio IS NULL
...
<table class="table table-bordered datatable" id="table-1">
    ...
    <tbody>
        ...
        while ($registro = $bd->getFila($registros)) {
            ...
            echo "<td><span class='btn btn-info btn-xs'>$registro[estado_solicitud_servicio]</span></td>";
            ?>
            <td>
                <button type="button" class="btn btn-info btn-lg btn-xs" data-toggle="modal" data-target="#boton-modal_servicio" data_id="<?php echo $registro[id_solicitud_servicio] . '-servicio' ?>" id="botones-modal" onclick="getReportes(<?php echo $registro[id_solicitud_servicio]; ?>)">
                    Generar Reportes
                </button>
            </td>
            </tr>
...
<div class="modal fade" id="boton-modal_servicio" role="dialog">
    <div class="modal-dialog modal-lg">
        <!-- Vista de la Solicitud content-->
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body" align="center">
                <a style="width: 450px;" target='_blank' class='letras_boton btn btn-info' id="print_form_1_servicio" name="print_form_1_servicio">
                    Imprimir
                    <i class='entypo-print'></i>
                </a>
                <br>
                <a style="width: 450px;" target='_blank' class="letras_boton btn btn-success" id="print_form_5_servicio" name="print_form_5_servicio">
                    Nota de Adjudicación
                    <i class="entypo-print"></i>
                </a>
                <br>
                <a style="width: 450px;" target='_blank' class="letras_boton btn btn-info" id="print_form_6_servicio" name="print_form_6_servicio">
                    Imprimir Orden de Material
                    <i class="entypo-print"></i>
                </a>
                <br>
                <a style="width: 450px;" target='_blank' class="letras_boton btn btn-success" id="print_form_2_servicio" name="print_form_2_servicio">
                    Acta conformidad
                    <i class="entypo-print"></i>
                </a>
                <br>
                <a style="width: 450px;" target='_blank' class="letras_boton btn btn-danger" id="print_form_3_servicio" name="print_form_3_servicio">
                    Acta no conformidad
                    <i class="entypo-print"></i>
                </a>
                <br>
                <a style="width: 450px;" target='_blank' class="letras_boton btn btn-warning" id="print_form_4_servicio" name="print_form_4_servicio">
                    Informe de Adjudicacion
                    <i class="entypo-print"></i>
                </a>
                <br>
                <a style="width: 450px;" target='_blank' class="letras_boton btn btn-success" id="print_form_7_servicio" name="print_form_7_servicio">
...
<script>
    ...
    function getReportes(id) {
        ...
        fetch('control/derivaciones/buscar_solicitud.php?id=' + id + '&tipo=' + tipo)
            ...
            .then(res => {
                ...
                let botones = ["print_form_1_servicio", "print_form_5_servicio", "print_form_6_servicio", "print_form_2_servicio", "print_form_3_servicio", "print_form_4_servicio", "print_form_7_servicio"];
                let urls = [];
                console.log(respuesta);
                let timestamp = new Date().getTime(); // obtener el timestamp actual
                urls.push(`vista/solicitud_servicio/pdf.php?id=${respuesta.id_solicitud_servicio}&t=${timestamp}`);
                urls.push(`vista/derivaciones/nota_adjudicacion_pdf.php?id_solicitud=${respuesta.id_solicitud_servicio}&id_detalle=${respuesta.id_detalle}&tipo=servicio&t=${timestamp}`);
                urls.push(`vista/derivaciones/pdf.php?id_solicitud=${respuesta.id_solicitud_servicio}&id_detalle=${respuesta.id_detalle}&tipo=servicio&t=${timestamp}`);
                if (productos) {
                    urls.push(`vista/derivaciones/acta_conformidad_no_conformidad_pdf.php?id_solicitud=${respuesta.id_solicitud_servicio}&id_detalle=${respuesta.id_detalle_servicio}&tipo=servicio&id_requisitos=${respuesta.id_requisitos}&conformidad=si&t=${timestamp}`);
                    urls.push(`vista/derivaciones/acta_conformidad_no_conformidad_pdf.php?id_solicitud=${respuesta.id_solicitud_servicio}&id_detalle=${respuesta.id_detalle}&tipo=servicio&id_requisitos=${respuesta.id_requisitos}&conformidad=no&t=${timestamp}`);
                    urls.push(`vista/derivaciones/pdf_proveedores_seleccionados.php?id_solicitud=${respuesta.id_solicitud_servicio}&id_proveedor=${respuesta.id_proveedor}&tipo=servicio&id_detalle=${respuesta.id_detalle}&t=${timestamp}`);
                    urls.push(`vista/derivaciones/acta_recepcion_pdf.php?id_solicitud=${respuesta.id_solicitud_servicio}&id_detalle=${respuesta.id_detalle}&tipo=servicio&id_requisitos=${respuesta.id_requisitos}&aclaracion=Sin Observaciones&t=${timestamp}`);
                }
                console.log(urls);
    ...
    function exportarPDF(nombre, contenedor) {
        ...
        if (es_chrome) {
            ...
            // console.log(estilos + '<html><body> <h2 align="center">REPORTE SEGUIMIENTO SOLICITUD DE servicio </h2> <h3 align="center">Nro. </h3>' + multa + '</body>')
