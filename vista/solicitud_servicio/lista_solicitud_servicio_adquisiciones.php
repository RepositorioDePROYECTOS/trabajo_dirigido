<?php
    ...
    where ( s.estado_solicitud_servicio='ADQUISICION' 
    or s.estado_solicitud_servicio='COMPRADO' )
    ...
    while($registro = $bd->getFila($registros)) 
    {
        ...
        echo utf8_encode("
            ...
            if($registro[estado_solicitud_servicio]=='ADQUISICION' || $registro[estado_solicitud_servicio]=='COMPRADO'){
                echo "<a href='?mod=solicitud_servicio&pag=detalle_servicio&id_solicitud_servicio=$registro[id_solicitud_servicio]' class='btn btn-info btn-icon view_modal_detail' style='float: right; margin-right: 5px;'>Ver detalle <i class='entypo-eye'></i></a><br><a target='_blank' href='vista/reportes/visor_reporte.php?f=vista/solicitud_servicio/pdf.php&id=$registro[id_solicitud_servicio]' class='btn btn-info btn-icon' style='float: right; margin-right: 5px;'>Imprimir<i class='entypo-print'></i></a><br>";
            }
           echo "</td>";
