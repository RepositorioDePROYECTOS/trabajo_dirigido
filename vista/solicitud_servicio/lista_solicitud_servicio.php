...
if ($_SESSION[nivel] == 'PRESUPUESTO') {
    ...
    $registros = $bd->Consulta("SELECT * FROM solicitud_servicio s 
        ...
        OR s.estado_solicitud_servicio='PRESUPUESTADO' 
        OR s.estado_solicitud_servicio='PROVEEDOR ASIGNADO' 
        OR s.estado_solicitud_servicio='VISTO BUENO RPA' 
        OR s.estado_solicitud_servicio='VISTO BUENO G.A.' 
        OR s.estado_solicitud_servicio='SIN VISTO BUENO G.A.' 
        OR s.estado_solicitud_servicio='SIN VISTO BUENO RPA'
        OR s.estado_solicitud_servicio='MEMORANDUN' )
        AND s.programa_solicitud_servicio IS NULL
        AND s.actividad_solicitud_servicio IS NULL
        order by s.id_solicitud_servicio DESC");
    ...
    $registros = $bd->Consulta("SELECT * FROM solicitud_servicio s 
        ...
        LEFT JOIN eventual e ON e.id_eventual = u.id_eventual
        INNER JOIN derivaciones as d ON d.id_solicitud = s.id_solicitud_servicio
        WHERE s.estado_solicitud_servicio='PRESUPUESTADO' 
        AND s.programa_solicitud_servicio IS NULL
        AND s.actividad_solicitud_servicio IS NULL
        order by s.id_solicitud_servicio DESC");
}
