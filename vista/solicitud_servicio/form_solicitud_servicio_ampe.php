...
<div class="panel panel-default panel-shadow" data-collapsed="0">
	...
	<div class="panel-body">
		<form name="frm_solicitud_servicio" id="frm_solicitud_servicio" action="control/solicitud_servicio_ampe/insertar_solicitud_servicio_ampe.php" method="post" role="form" class="validate form-horizontal form-groups-bordered">
		...
		<input type="hidden" name="item_solicitante" id="item_solicitante" class="form-control required text" value='<?php echo $item_solicitante;?>'/>
			...
			<div class="form-group">
				<label for="programa_solicitud_servicio" class="col-sm-3 control-label">Programa</label>
				<div class="col-sm-2">
					<select name="programa_solicitud_servicio" id="programa_solicitud_servicio" class="form-control required">
				...
				<div class="col-sm-2">
					<select name="actividad_solicitud_servicio" id="actividad_solicitud_servicio" class="form-control required">
							<option value="" selected>--SELECCIONE--</option>
